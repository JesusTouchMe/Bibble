...
#ifndef BIBBLE_FRAMEWORK_INCLUDE_BIBBLE_PARSER_AST_STATEMENT_RETURNSTATEMENT_H
#define BIBBLE_FRAMEWORK_INCLUDE_BIBBLE_PARSER_AST_STATEMENT_RETURNSTATEMENT_H 1
...
namespace parser {
    ...
    public:
        ReturnStatement(symbol::Scope* scope, ASTNodePtr returnValue, lexer::Token token);
...
#endif // BIBBLE_FRAMEWORK_INCLUDE_BIBBLE_PARSER_AST_STATEMENT_RETURNSTATEMENT_H
